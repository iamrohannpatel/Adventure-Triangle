            ...
            <div className="container mx-auto px-6">
                <div className="grid md:grid-cols-4 gap-8 mb-12">
                    <div className="col-span-1 md:col-span-2">
                        <a href="#" className="flex items-center gap-3 group relative w-fit mb-6">
                            ...
                            <span className="text-xl font-bold tracking-tighter text-white group-hover:tracking-wide transition-all duration-300">
                                Adventure Triangle
                            </span>
                        </a>
                        ...
                        <div className="flex gap-4">
                            ...
                            <a href="https://www.instagram.com/adventure.triangle?igsh=MWR2M2R4bHJ6amd3" target="_blank" rel="noopener noreferrer" className="w-10 h-10 rounded-full bg-white/5 flex items-center justify-center text-slate-400 hover:bg-gradient-to-tr hover:from-yellow-400 hover:via-pink-500 hover:to-purple-500 hover:text-white transition-all border border-white/5 hover:border-pink-500/30 hover:scale-110 group">
                            ...
                            <a href="https://www.linkedin.com/company/adventuretriangle/" target="_blank" rel="noopener noreferrer" className="w-10 h-10 rounded-full bg-white/5 flex items-center justify-center text-slate-400 hover:bg-[#0077b5] hover:text-white transition-all border border-white/5 hover:border-[#0077b5]/30 hover:scale-110 group">
                    ...
                    <div>
                        ...
                        <ul className="space-y-2 text-slate-400 text-sm">
                            ...
                            <li><a href="#mission" className="hover:text-blue-400 transition-colors">Our Mission</a></li>
                            <li><a href="#partner" className="hover:text-blue-400 transition-colors">Partnerships</a></li>
                    ...
                    <div>
                        ...
                        <div className="flex flex-col gap-1">
                            <span className="text-xs text-slate-500">Designed and Developed by</span>
                            <a href="https://www.linkedin.com/in/iamrohannpatel/" target="_blank" rel="noopener noreferrer" className="flex items-center gap-2 text-slate-400 hover:text-blue-400 transition-colors text-sm font-medium w-fit">
                                <span>developerohan</span>
                                <svg className="w-4 h-4 fill-current" viewBox="0 0 24 24"><path d="M20.447 20.452h-3.554v-5.569c0-1.328-.027-3.037-1.852-3.037-1.853 0-2.136 1.445-2.136 2.939v5.667H9.351V9h3.414v1.561h.046c.477-.9 1.637-1.85 3.37-1.85 3.601 0 4.267 2.37 4.267 5.455v6.286zM5.337 7.433c-1.144 0-2.063-.926-2.063-2.065 0-1.138.92-2.063 2.063-2.063 1.14 0 2.064.925 2.064 2.063 0 1.139-.925 2.065-2.064 2.065zm1.782 13.019H3.555V9h3.564v11.452zM22.225 0H1.771C.792 0 0 .774 0 1.729v20.542C0 23.227.792 24 1.771 24h20.451C23.2 24 24 23.227 24 22.271V1.729C24 .774 23.2 0 22.222 0h.003z"></path></svg>
                            </a>
                        </div>
                    </div>
                ...
                <div className="text-center pt-8 border-t border-white/10 text-slate-500 text-sm">
                    <p>&copy; {new Date().getFullYear()} Adventure Triangle. All rights reserved.</p>
                </div>
            </div>
        </footer>
    );
